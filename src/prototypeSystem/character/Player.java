...
public class Player {
    ...
    public Player(int id, String name, int level, int maxHealth, int currentHealth,  int currentEXP, int strengthAbility, int dexterityAbility, int intelligenceAbility,int usedExp, int mapUnlock, int money) {
        this.id = id;
        this.name = name;
        this.level = level;
